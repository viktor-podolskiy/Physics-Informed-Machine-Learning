...
mMax=75; %controls the size of A matrix 

Npix=10; %not more than 2*maxM+1
Nlvs=2; % maximum refractive index; either 2 or 4 in this work

prbPlasm=0; %0.25; %probability of having plasmonic layers
...
save('dataFull.mat','nmEvs','Lam','geomTbl','lam0','lenhVec',...
    'nmEvs','targetTbl'); 
